...
function createNote(){
    ...
    "width: 250px; height:250px; font-size: 26px; padding: 25px; margin-top: 10px; overflow: hidden; box-shadow: 10px 10px 24px 0px rgba(0,0,0,0.75);");
...
function color(){
    let random_color = ["#c6da5aa8","#f04b19a8","#86f05ca8","#62acf1a8","White","#f575cea8"];
